...
${bookmark}    876524_bookmark
${url}    tmp.876524_bookmark.com
${desc}    temporary bookmark for case 876524
${ftp_server}    ${PC5_VLAN30_IP}
${ftp_username}    ${PC5_USERNAME}
${ftp_password}    ${PC5_PASSWORD}
@{backup_cli_cmd}    execute backup config ftp 876524.config ${ftp_server} ${ftp_username} ${ftp_password}
${ssh_server}    ${PC5_VLAN10_IP}
${ssh_username}    ${PC5_USERNAME}
${ssh_password}    ${PC5_PASSWORD}
${ssh_port}    ${PC5_SSH_PORT}
@{ssh_cmd}    cat 876524.config|grep ${bookmark}
@{cli_cmd}    sh vpn ssl web user-bookmark ${SSLVPN_GUI_USERNAME}\#${FGT_USER_GROUP_NAME}
${FGT_KEYWORD_MAX_RUNNING_TIME}    10 min
*** Test Cases ***
876524
    [Tags]    v6.0    firefox    chrome    edge    safari    876524    critical    win10,64bit
    Login SSLVPN Portal
    #create a bookmark
