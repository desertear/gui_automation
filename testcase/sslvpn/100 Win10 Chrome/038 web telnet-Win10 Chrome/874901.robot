...
${telnet_host2}    ${SSLVPN_LINUX_SERVER2}
${telnet_username2}    ${SSLVPN_TELNET_USERNAME}
${telnet_password2}    ${SSLVPN_TELNET_PASSWORD}
${bookmark_name2}    telnet_automation2
${bookmark_description2}    automation test for bookmark ${bookmark_name2}

*** Test Cases ***
874901
    [Tags]   v6.0    no_grid    chrome    firefox    874901    high    win10,64bit
    ...
    create bookmark telnet    ${bookmark_name2}    ${telnet_host2}   ${bookmark_description2}
    # open telnet bookmark and keep it
    open and cli check telnet bookmark    ${bookmark_name2}    ${telnet_host2}    ${telnet_username2}    ${telnet_password2}
