*** Settings ***
Documentation    Verify two users connect to sslvpn web portal, could HTTP to same HTTP server simultaneously
...   Action:
...
*** Test Cases ***
874883
    [Tags]    v6.0    chrome    firefox    874883    high    win10,64bit
    ...
    input text    ${QUICK_HTTP_URL_TEXT}    ${http_url}
    ...
    quick connection of http or https    ${http_url}    ${matching_text}
