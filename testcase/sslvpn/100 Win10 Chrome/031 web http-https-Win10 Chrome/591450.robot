*** Settings ***
Documentation    Verify SSO HTTPS  form data works with static configuration from personal boomark
...
${key2}    password
${value2}    ${FAC_PASSWORD}
${bookmark_name}   http_sso_591450
${bookmark_description}    automation test for bookmark ${bookmark_name}
${matching_text}    ${FAC_HEAD}
*** Test Cases ***
591450
    [Tags]    v6.0    chrome    firefox    edge    safari    591450    high    win10,64bit
