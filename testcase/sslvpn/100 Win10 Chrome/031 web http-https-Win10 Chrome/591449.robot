*** Settings ***
Documentation    Verify SSO HTTPS  form data works with automatic configuration from personal boomark
...
${key2}    password
${value2}    ${FAC_PASSWORD}
${bookmark_name}   http_sso_591449
${bookmark_description}    automation test for bookmark ${bookmark_name}
${matching_text}    ${FAC_HEAD}
*** Test Cases ***
591449
    [Tags]    v6.0    chrome    firefox    edge    safari    591449    high    win10,64bit
