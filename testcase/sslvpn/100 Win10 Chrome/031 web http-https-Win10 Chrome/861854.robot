*** Settings ***
Documentation    Verify personal SSO HTTPS bookmark can be access with "alternative" sso credential.
...
${bookmark_name}   http_sso_861854
${bookmark_description}    automation test for bookmark ${bookmark_name}
${matching_text}    ${FAC_HEAD}
*** Test Cases ***
861854
    [Tags]    v6.0    chrome    firefox    edge    safari    861854    high    win10,64bit 
