*** Settings ***
Documentation    verify sslvpn web portal can visit same version FGT admin login page, vdom and tabs
...   Action:
...
*** Test Cases ***
183056
    [Tags]    v6.0    chrome    firefox    edge    safari    183056    critical    win10,64bit    bug
    Login SSLVPN Portal
