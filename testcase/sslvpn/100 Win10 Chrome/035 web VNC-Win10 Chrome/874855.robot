*** Settings ***
Documentation    Verify two users connect to sslvpn web portal, could VNC to same VNC server simultaneously
...    Action:
...
*** Test Cases ***
874855
    [Tags]   v6.0    no_grid    chrome    firefox    874855    high    win10,64bit
