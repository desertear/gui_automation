*** Settings ***
Documentation    Verify login history entry can be shown normally if logs are stored in memory.
...    Go vpn>ssl>portal page, create new sslvpn portal.
...    Enable log memory setting.
...
*** Test Cases ***
751157
    [Tags]    v6.0    firefox    chrome    edge    safari    751157    high    win10,64bit
