*** Settings ***
Documentation    Verify "Launch" button show outside the sslvpn login page and the button works for windows forticlient 6.0
Library    SikuliLibrary    mode=NEW
Resource    ../../sslvpn_resource.robot
Suite Setup    begin 860899 test
...
*** Test Cases ***
860899
    [Tags]    screen_alive    no_grid    forticlient    v6.0    chrome    860899    high    win10,64bit
    ...
    click element    ${LOGIN_SSLVPN_LAUNCH_FORTICLIENT_BUTTON}
