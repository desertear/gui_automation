*** Settings ***
Documentation    Verify login history entry can be shown normally if logs are stored in hard disk.
...    Go vpn>ssl>portal page, create new sslvpn portal.
...    Enable log disk setting.
...
*** Test Cases ***
751154
    [Tags]    v6.0    firefox    chrome    edge    safari    disk    751154    high    win10,64bit
