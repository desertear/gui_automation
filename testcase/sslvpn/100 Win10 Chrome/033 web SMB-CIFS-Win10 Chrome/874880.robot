*** Settings ***
Documentation    Verify two users connect to sslvpn web portal, could SMB to different SMB server
...    Action:
...
${matching_text}    ${SSLVPN_SMB_TEST_FILE}
${smb_host2}    ${SSLVPN_LINUX_SERVER2}
${smb_username2}    ${SSLVPN_SMB_USERNAME}
${smb_password2}    ${SSLVPN_SMB_PASSWORD}
##Please only put case level variables here, while global variables should be set in env.robot
*** Test Cases ***
874880
    [Tags]    v6.0    chrome    firefox    874880    high    win10,64bit
    ...
    connect to smb    ${smb_host2}    username=${smb_username2}    password=${smb_password2}
