*** Settings ***
Documentation    Verify SSL VPN clientless HTML5 RDP/VNC support (0299863)
Library    SikuliLibrary    mode=NEW
Resource    ../../sslvpn_resource.robot
Suite Setup    begin 837019 test
...
*** Test Cases ***
837019
    [Documentation]    This case is same as 813614, because both cases are based on HTML5 clientless design
    [Tags]    no_grid    v6.0    firefox    chrome    edge    safari    837019    high    win10,64bit
