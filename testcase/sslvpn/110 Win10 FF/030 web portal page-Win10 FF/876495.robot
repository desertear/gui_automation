...
${bookmark}    876495_bookmark
${url}    tmp.876495_bookmark.com
${desc}    temporary bookmark for case 876495
${ftp_server}    ${PC5_VLAN30_IP}
${ftp_username}    ${PC5_USERNAME}
${ftp_password}    ${PC5_PASSWORD}
@{backup_cli_cmd}    execute backup config ftp 876495.config ${ftp_server} ${ftp_username} ${ftp_password}
${ssh_server}    ${PC5_VLAN10_IP}
${ssh_username}    ${PC5_USERNAME}
${ssh_password}    ${PC5_PASSWORD}
${ssh_port}    ${PC5_SSH_PORT}
@{ssh_cmd}    cat 876495.config|grep ${bookmark}
@{cli_cmd}    sh vpn ssl web user-bookmark ${SSLVPN_GUI_USERNAME}\#${FGT_USER_GROUP_NAME}
*** Test Cases ***
876495
    [Tags]    v6.0    firefox    chrome    edge    safari    876495    critical    win10,64bit
    Login SSLVPN Portal
    #create a bookmark
