...
*** Test Cases ***
877285
    [Tags]    v6.0    chrome    firefox    edge    safari    877285    Medium    win10,64bit    bug
    # delete all logs
    ...
    should match regexp    ${response1}    reason="samba"
    ...
    should match regexp    ${response2}    reason="samba"
