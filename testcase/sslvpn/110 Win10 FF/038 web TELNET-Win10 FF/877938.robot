...
*** Test Cases ***
877938
    [Tags]    screen_alive   no_grid    v6.0    chrome    firefox    edge    safari    877938    critical    win10,64bit
    Login SSLVPN Portal
    create bookmark telnet    ${bookmark_name}    ${folder}    ${bookmark_description}
    open and cli check telnet bookmark    ${bookmark_name}    ${folder}    ${username}    ${password}    if_login=True
