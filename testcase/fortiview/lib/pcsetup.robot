*** Settings ***
Documentation     This file contains PC setup operations

*** Variables ***
@{ssh_cmd}    ip route del default    ip route add default via 10.1.100.7

*** Keywords ***
config pc1
    Execute commands on PC via SSH connection    ${PC1_SSH_EXT_IP}    ${PC1_USERNAME}   ${PC1_PASSWORD}    ${ssh_cmd}    port=${PC1_SSH_EXT_PORT}
