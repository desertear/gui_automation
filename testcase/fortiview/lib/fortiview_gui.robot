*** Settings ***
Documentation     This file contains Fortiview page operations

*** Variables ***

*** Keywords ***
Go to LANDMZSources
    Wait Until element is visible    ${LANDMZ_SOURCES}
    click element    ${LANDMZ_SOURCES}

Go to Fortiview
    Wait Until element is visible    ${FORTIVIEW}
    click element    ${FORTIVIEW}

Doubleclick drill down first entry
    Wait Until element is visible    ${FIRST_ENTRY}
    double click element    ${FIRST_ENTRY}

Switch to 5 minutes
    Wait Until element is visible    ${FORTIVIEW_TIME_SELECTION_BUTTON}
    click element    ${FORTIVIEW_TIME_SELECTION_BUTTON}
    Wait Until element is visible    ${FORTIVIEW_TIME_SELECTION_BUTTON_5 MINUTES}
    click element    ${FORTIVIEW_TIME_SELECTION_BUTTON_5 MINUTES}

Click back
    Wait Until element is visible    ${FORTIVIEW_DRILLDOWN_BACKBUTTON}
    click element    ${FORTIVIEW_DRILLDOWN_BACKBUTTON}


Right click drill down first entry
    Wait Until element is visible    ${FIRST_ENTRY}
    Right Click Element    ${FIRST_ENTRY}
    Wait Until element is visible    ${FORTIVIEW_RIGHTCLICK_DRILLDOWN_BUTTON}
    click element    ${FORTIVIEW_RIGHTCLICK_DRILLDOWN_BUTTON}

Drill down 1st to 2nd level
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_FIRSTENTRY}
    double click element    ${FORTIVIEW_1STLEVEL_FIRSTENTRY}

Check elements for summary of table
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_HOSTIP}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_BYTES}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_SESSIONS}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_AVATARICON}


Check elements on 1st level tabs
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_APPLICATIONS}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_DESTINATIONS}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_THREATS}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_WEBSITES}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_WEBCATEGORIES}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_SEARCHPHRASES}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_POLICIES}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_SESSIONS}

Check elements on 1st level column headers realtime
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_APPLICATIONS}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_CATEGORY}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_RISK}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_BYTES}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_SESSIONS}    
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_BANDWIDTH}
...
Check elements on 1st level column headers realtime sessions
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_SOURCE}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_DEVICE}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_DESTINATION}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_APPLICATIONS}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_PROTOCOL}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_SOURCEPORT}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_DESTINATIONPORT}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_BYTES}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_DURATION}

Check elements on 1st level column headers historical sessions
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_ICON_NUMBER}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_ICON_PAPERCLIP}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_DATETIME}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_SESSIONS_SOURCE}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_SESSIONS_DESTINATION}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_APPLICATIONNAME}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_SECURITYACTION}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_SECURITYEVENTS}
    Wait Until element is visible    ${FORTIVIEW_1STLEVEL_TABLE_SENTRECEIVED}

Check all elements on basic fortiview menu
    Wait Until element is visible    ${LANDMZ_SOURCES}
    click element    ${LANDMZ_SOURCES}
    Wait Until element is visible    ${LANDMZ_DESTINATIONS}
    click element    ${LANDMZ_DESTINATIONS}
    Wait Until element is visible    ${LANDMZ_APPLICATIONS}
    click element    ${LANDMZ_APPLICATIONS}
    Wait Until element is visible    ${LANDMZ_CLOUDAPPLICATIONS}
    click element    ${LANDMZ_CLOUDAPPLICATIONS}
    Wait Until element is visible    ${LANDMZ_WEBSITES}
    click element    ${LANDMZ_WEBSITES}
    Wait Until element is visible    ${LANDMZ_THREATS}
    click element    ${LANDMZ_THREATS}
    Wait Until element is visible    ${LANDMZ_TRAFFICSHAPING}
    click element    ${LANDMZ_TRAFFICSHAPING}
    Wait Until element is visible    ${FROMWAN_SOURCES}
    click element    ${FROMWAN_SOURCES}
    Wait Until element is visible    ${FROMWAN_SERVERS}
    click element    ${FROMWAN_SERVERS}
    Wait Until element is visible    ${FROMWAN_THREATS}
    click element    ${FROMWAN_THREATS}
    Wait Until element is visible    ${ALLSEGMENTS_SYSTEMEVENTS}
    click element    ${ALLSEGMENTS_SYSTEMEVENTS}
    Wait Until element is visible    ${ALLSEGMENTS_ENDPOINTVUL}
    click element    ${ALLSEGMENTS_ENDPOINTVUL}
    Wait Until element is visible    ${ALLSEGMENTS_THREATMAP}
    click element    ${ALLSEGMENTS_THREATMAP}
    Wait Until element is visible    ${ALLSEGMENTS_POLICIES}
    click element    ${ALLSEGMENTS_POLICIES}
    Wait Until element is visible    ${ALLSEGMENTS_INTERFACES}
    click element    ${ALLSEGMENTS_INTERFACES}
    Wait Until element is visible    ${ALLSEGMENTS_ALLSESSIONS}
    click element    ${ALLSEGMENTS_ALLSESSIONS}
...
download ftp file by clcking filename
