*** Settings ***
Documentation    Create ipv4 vwp policy, verify proxy-based policy can be created/deleted using non default utm profile
...
893416
    [Documentation]    
    [Tags]    chrome    893416    High   firewall_new
    ...
    ...    always    ALL    ACCEPT     direction=bi    security_profile=${security_profile_list}
    ...
    ...    always    ALL    ACCEPT    direction=left    security_profile=${security_profile_list}
    sleep   2
