*** Settings ***
Documentation    Create IPV6 VWP Policy: Verify basic DENY policy can be created/deleted with bi-direction, srcaddr, dstaddr schedule and service
...
893422
    ...
    ...    always    ALL    DENY     direction=bi    ip_version=6
