*** Settings ***
Documentation    Create ipv4 policy, verify proxy-based policy can be created/deleted using default utm profile
...
893243
    [Documentation]    
    [Tags]    chrome    893243    High   firewall_new
    [setup] 
    ...
    ...    always    ALL    ACCEPT    enable    inspection_mode=Proxy-based   security_profile=${security_profile_list}   multi_intf=${multi_intf}
