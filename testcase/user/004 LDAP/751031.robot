*** Settings ***
Documentation    Verify when configuring remote groups, can select groups from an LDAP browser if the remote server type is LDAP (mantis 215638)
