*** Settings ***
Documentation    Verify GUI main dashboard and interface page works well when login with vdom admin after enable split vdom
...
*** Test Cases ***
878973
    [Tags]    v6.0    chrome   878973    High    win10,64bit    browsers    runable      rest
    ...
    Create Administrator  username=${username}   password=${password}   vdom=${vdom}   admin_profile=prof_admin
    Logout FortiGate  
