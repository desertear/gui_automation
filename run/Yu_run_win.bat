...
::WanOpt
python -m robot --timestampoutputs --loglevel TRACE:TRACE -v FGT_ENV:env_Yu.robot -v WANOPT_ENV:wanopt_env.robot -l ./log/log.html -r ./report/report.html -o ./output/output.xml -i 739606 ./