...
:: DLP
::python -m robot --timestampoutputs --loglevel TRACE:TRACE -v FGT_ENV:env_Jonathan.robot -v DLP_ENV:dlp_env.robot -l ./log/log.html -r ./report/report.html -o ./output/output.xml -i 756657 ./

:: IPS
python -m robot --timestampoutputs --loglevel TRACE:TRACE -v FGT_ENV:env_Jonathan.robot -v IPS_ENV:ips_env.robot -l ./log/log.html -r ./report/report.html -o ./output/output.xml -i 205786 ./