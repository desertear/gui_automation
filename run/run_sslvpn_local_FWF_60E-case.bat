...
python -m robot --timestampoutputs --loglevel TRACE:TRACE -v VERSION:6.2 -v FGT_ENV:env.local_FWF_60E.robot -v SSLVPN_ENV:sslvpn_env.robot -l ./log/log.html -r ./report/report.html -o ./output/output.xml -e norun -e disk -i 874915 --suite "100 Win10 Chrome" ./ 