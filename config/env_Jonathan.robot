...
${TERMINAL_SERVER_IP}    172.18.70.40
${TERMINAL_SERVER_PORT}    23
${FGT_TELNET_PORT_ON_TERMINAL_SERVER}    2003
...
${FGT_VLAN10_IP}    10.6.30.5
#${FGT_VLAN10_IP_V6}    2000:10:6:30::1
${FGT_VLAN30_IP}    172.16.200.5
${FGT_VLAN30_IP_V6}    2000:172:16:200::5
#Because GUI access IPs can be mapped to external IPs.Below Vlan20 addresses are used internal.
${FGT_VLAN20_IP}    10.1.100.5
${FGT_VLAN20_IP_V6}    2000:10:1:100::5
...
##PC5 configurations
${PC5_VLAN10_IP}    10.6.30.56
${PC5_VLAN30_IP}    172.16.200.56
${PC5_SSH_PORT}    22
${PC5_USERNAME}    root
${PC5_PASSWORD}    123456
${PC5_OS_TYPE}    Linux
