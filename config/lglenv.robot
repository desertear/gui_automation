...
${ORIOLE_ENCODED_PASSWORD}    Vm1kTlJFUkdXVTlXTVdSS1FtZE5TRlZTTVZGQ1VVRkhVMVl4Vmxoc1pFcFZiRTVTUVVaU1ZsZG5UbEpXYkZKaw==
...
##FGT CLI via Terminal Server configuration
...
${TERMINAL_SERVER_IP}    172.16.106.84
...
${FGT_CLI_SSH_CONNECTION_IP}    172.16.200.1
${FGT_CLI_SSH_PORT}    22
${FGT_CLI_SSH_CONNECTION_TIMEOUT}    10
...
${FGT_SN}    	FG3H1E5818900515
${FGT_HW_TYPE}    FortiGate-301E
