...
${FGT_SN}    FGT52E3U17000096
${FGT_HOSTNAME}    FGT52E-NAT-WF
${FGT_GENERATION}    Gen1
${FGT_TEST_VERSION}    6.2.0
${BRANCH_NAME}    ${EMPTY}
${FGT_GUI_ACCESS_INTERFACE}    wan2 
${FGT_VLAN10_INTERFACE}    mgmt
${FGT_VLAN20_INTERFACE}    wan2
${FGT_VLAN30_INTERFACE}    wan1
${GENERAL_SERVER}    172.16.200.60
...
${ORIOLE_ACCOUNT}    wwang01
#this one can be get from "user profile" after you login Oriole
${ORIOLE_ENCODED_PASSWORD}      UVd4T1VsZG5SbU5DUmxaS1FtZGFWRlZvTVZGQ1VVRktVMUZXWkVSUlNrcFZiRTVTUVVaU1ZsZG5UbEpXYkZKaw==
...
${TERMINAL_SERVER_IP}    172.18.52.122
${TERMINAL_SERVER_PORT}    23
${FGT_TELNET_PORT_ON_TERMINAL_SERVER}    2009
...
#${FGT_VLAN10_IP}    10.6.30.4
#${FGT_VLAN10_IP_V6}    2000:10:6:30::1
${FGT_VLAN30_IP}    172.16.200.6
#${FGT_VLAN30_IP_V6}    2000:172:16:200::4
#Because GUI access IPs can be mapped to external IPs.Below Vlan20 addresses are used internal.
${FGT_VLAN20_IP}    10.1.200.6
#${FGT_VLAN20_IP_V6}    2000:10:1:100::4
...
##PC5 configurations
${PC5_VLAN10_IP}    10.6.30.60
${PC5_VLAN30_IP}    172.16.200.60
${PC5_SSH_PORT}    22
${PC5_USERNAME}    root
${PC5_PASSWORD}    123456
${PC5_OS_TYPE}    Linux
...
##PC1 configurations
${PC1_VLAN10_IP}    10.6.30.15
${PC1_VLAN20_IP}    10.1.200.15
${PC5_SSH_PORT}    22
${PC1_USERNAME}    root
${PC1_PASSWORD}    123456
${PC1_OS_TYPE}    Linux
