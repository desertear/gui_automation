...
${ORIOLE_ACCOUNT}    tguan
#this one can be get from "user profile" after you login Oriole
${ORIOLE_ENCODED_PASSWORD}    Vm1kTlJFUlJiMHRDVmxwS1FtZE5TRlZTTVZGQ1VVRkhVMVl4Vmxoc1pFcFZiRTVTUVVaU1ZsZG5UbEpXYkZKaw==
...
${FGT_IP_ADDRESS}   10.1.100.7
${FGT_IP_ADDRESS_V6}   2000:10:1:100::7
${FGT_PORT}    443
...
${TERMINAL_SERVER_IP}    10.6.30.10
${TERMINAL_SERVER_PORT}    23
${FGT_TELNET_PORT_ON_TERMINAL_SERVER}    2006
...
${FGT_CLI_FGT_TELNET_CONNECTION_IP}    10.1.100.7
${FGT_CLI_TELNET_PORT}    23
${FGT_CLI_TELNET_CONNECTION_TIMEOUT}    10

#FGT CLI Via SSH Connection
${FGT_CLI_SSH_HOST}    172.16.200.7
${FGT_CLI_SSH_PORT}    22
