...
${FGT_SN}    FG5H1E5818900212
#${FGT_HOSTNAME}    ${FGT_SN}
${FGT_HOSTNAME}    FortiGate-501E
${FGT_GENERATION}    Gen1
${FGT_TEST_VERSION}    6.2.0
${BRANCH_NAME}    ${EMPTY}
${FGT_GUI_ACCESS_INTERFACE}    mgmt
${FGT_VLAN10_INTERFACE}    mgmt
${FGT_VLAN20_INTERFACE}    port1
${FGT_VLAN30_INTERFACE}    port3
${GENERAL_SERVER}    172.16.200.55
${FGT_CLI_LOG_DIR}    ${CURDIR}${/}..${/}log
${FW_TEST_VDOM_NAME_1}    vdom1
#your LDAP account to login Oriole, you need to change it once you change your ldap password
${ORIOLE_ACCOUNT}    yuzhu
#this one can be get from "user profile" after you login Oriole
${ORIOLE_ENCODED_PASSWORD}      Vm1kTlJFUldWVTlCWjJSS1FtZE5TRlZTTVZGQ1VVRkhVMVl4Vmxoc1pFcFZiRTVTUVVaU1ZsZG5UbEpXYkZKaw==
...
${FGT_IP_ADDRESS}   10.6.30.2
${FGT_IP_ADDRESS_V6}   2000:10:1:100::2
${FGT_PORT}    443
...
${TERMINAL_SERVER_IP}    172.18.62.165
${TERMINAL_SERVER_PORT}    23
${FGT_TELNET_PORT_ON_TERMINAL_SERVER}    2011
...
${FGT_VLAN10_IP}    10.6.30.2
${FGT_VLAN10_IP_V6}    2000:10:6:30::2
${FGT_VLAN30_IP}    172.16.200.2
${FGT_VLAN30_IP_V6}    2000:172:16:200::2
#Because GUI access IPs can be mapped to external IPs.Below Vlan20 addresses are used internal.
${FGT_VLAN20_IP}    10.1.100.2
${FGT_VLAN20_IP_V6}    2000:10:1:100::2
...
##PC1 configurations
${PC1_VLAN10_IP}    10.6.30.12
${PC1_VLAN20_IP}    10.1.100.12
${PC5_SSH_PORT}    22
${PC1_USERNAME}    root
${PC1_PASSWORD}    123456
${PC1_OS_TYPE}    Linux
...
##PC2 configurations
${PC2_VLAN10_IP}    10.6.30.23
${PC2_VLAN20_IP}    10.1.100.23
${PC5_SSH_PORT}    22
${PC2_USERNAME}    root
${PC2_PASSWORD}    123456
${PC2_OS_TYPE}    Linux
